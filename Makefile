...
.PHONY: help init setup config cameras calibrate-follower calibrate-leader teleop record resume train rollout $(KNOWN_TASKS)
...
resume:
	...
	@TASK="$(TASK)" RECORD_RESUME=true bash scripts/record_dataset.sh
